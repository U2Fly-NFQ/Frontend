...
function AdminDashboard() {
  ...
  return (
    <div className="admin-layout">
      <Row gutter={20}>
        <Col span={8}>
          <Card title={<div>Revenue</div>} bordered={false}>
            Total Booking Flight
          </Card>
        </Col>
        <Col span={8}>
          <Card title={<div>Total flight</div>} bordered={false}>
            Card content
          </Card>
        </Col>
        <Col span={8}>
          <Card title={<div>Total success booking</div>} bordered={false}>
            Card content
          </Card>
        </Col>
      </Row>
      <div className="admin-layout__chart">
        <div className="admin-layout__chart__title">
